  ...
  return (
    <AppShell
      router={({ path }) => [
        {
          path: `${path}/home`,
          component: loadable(() => import("../admin/panels/Home")),
        },
        {
          path: `${path}/users`,
          component: loadable(() => import("../admin/panels/Users")),
        },
      ]}
    >
      <Sidebar.Menu>
      ...
      <Sidebar.Item to="/dashboard/home" icon={<Home />}>
        主页
      </Sidebar.Item>
      <Sidebar.Item to="/dashboard/search" icon={<Search />}>
        搜索
      </Sidebar.Item>
